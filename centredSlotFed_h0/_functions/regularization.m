...
double precision; format long;
    ...
    for n_=1:n
        K1Dan = K1_i1(:,:,n_)/et_i1;	K1Ean = K1_i0(:,:,n_)/et_i1*Ii;  	K1Fan = K1_i0(:,:,n_)/et_i0;   	K1Tan = K1Dan - K1Ean;
        K3Dan = K3_i0(:,:,n_)/et_i0;	K3Ean = K3_i1(:,:,n_)/et_i0*Is;     K3Fan = K3_i1(:,:,n_)/et_i1;   	K3Tan = K3Dan - K3Ean;
        ...
        CZan_ = Z3Tan - Z1Tan/K1Tan*K3Tan;   A1s =  Z1__s(1,1,n_)*d1;       CZan(:,:,n_) = CZan_;
        CKan_ = K3Dan + K1Ean/K1Tan*K3Tan;   A3s =  Z3__s(1,1,n_)*d0;       Gan(:,:,n_) = I_N - fz(n_)/fk(n_)*(Omg_a\CKan_)/CZan_;

        CKbn_ = K3Tbn - K1Tbn/Z1Tbn*Z3Tbn;   B1s =  K1__s(1,1,n_)*d1;       CKbn(:,:,n_) = CKbn_;
        CZbn_ = Z3Dbn + Z1Ebn/Z1Tbn*Z3Tbn;   B3s =  K3__s(1,1,n_)*d0;       Gbn(:,:,n_) = I_N - fk(n_)/fz(n_)*(Omg_b\CZbn_)/CKbn_;
